 ...
 */
class Organisation extends \App\Entity\Organisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Organisation' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Organisation' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Organisation' . "\0" . 'address', '' . "\0" . 'App\\Entity\\Organisation' . "\0" . 'users', 'phoneNumber'];
        }
